...
class EntityRenderer:
    ...
    def prepare_textured_model(self, model):
        ...
        if model.texture.get_has_transparency():
        ...
        glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, model.texture.texture_image.get_width(),
                        model.texture.texture_image.get_height(), GL_RGBA, GL_UNSIGNED_BYTE,
                        model.texture.get_texture_data())
    ...
    def prepare_entity(self, entity):
        transformation_matrix = m.Maths().create_transformation_matrix(entity.get_position(), entity.get_rotation_x(),
                                                                       entity.get_rotation_y(), entity.get_rotation_z(),
                                                                       entity.get_scale())
